...
d3.csv("../output_data/mm6.csv").then(function(data) {
    console.log(data);
});

let dropdownMenu = d3.select("#selDataset");
dropdownMenu.append('option').attr('value','Maison Margiela').text('Maison Margiela');
dropdownMenu.append('option').attr('value','Diesel').text('Diesel');
dropdownMenu.append('option').attr('value','Blumarine').text('Blumarine');

// Set up an initial default plot
//function init() {
    // Fetch data and set up variables
